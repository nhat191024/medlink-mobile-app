...
class HistoryAppointmentDetail extends StatelessWidget {
  ...
  buildReviewModal;
  final Function(BuildContext context, String appointmentId, String name, String avatar)
  buildSupportModal;
  ...
  const HistoryAppointmentDetail({
    ...
    required this.buildReviewModal,
    required this.buildSupportModal,
  });
    ...
    return Row(
      ...
      children: [
        CustomButtonPlus(
          ...
          isDisabled: appointment.isReviewed,
          color: AppColors.primaryText,
          btnText: 'review'.tr,
          fontFamily: AppFontStyleTextStrings.bold,
          textSize: 16,
