...
class HistoryAppointmentsScreen extends GetView<DoctorMyAppointmentsControllers> {
  HistoryAppointmentsScreen({super.key});
                    ...
                    Expanded(
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          final appointment = controllers.historyAppointments.reversed.toList()[index];
