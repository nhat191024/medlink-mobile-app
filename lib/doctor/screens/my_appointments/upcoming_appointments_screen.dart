...
class UpcomingAppointmentsScreen extends GetView<DoctorMyAppointmentsControllers> {
  UpcomingAppointmentsScreen({super.key});

  final DoctorMyAppointmentsControllers controllers = Get.put(DoctorMyAppointmentsControllers());
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          Obx(
            () {
              if (controllers.upcomingQuantity.value == 0) {
                return Center(
                  child: Column(
                  ...
                  children: [
                    Expanded(
                      child: ListView.builder(
                        ...
                        itemCount: controllers.upcomingAppointments.length,
                        itemBuilder: (context, index) {
                          final appointment = controllers.upcomingAppointments[index];
                          return GestureDetector(
                            onTap: () {
                              controller.buildUpcomingAppointmentDetail(context, appointment, index);
                            },
                            child: Card(
                                    ...
                                    child: Row(
                                      children: [
                                        Container(
                                          ...
                                          child: Image.network(
                                            appointment.avatar,
                                            fit: controllers.checkIfDefaultAvatar(appointment.avatar) ? BoxFit.scaleDown : BoxFit.cover,
                                          ),
                                        ),
