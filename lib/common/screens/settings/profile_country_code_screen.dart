...
class ProfileCountryCodeScreen extends StatefulWidget {
  const ProfileCountryCodeScreen({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _ProfileCodeScreenState createState() => _ProfileCodeScreenState();
}

class _ProfileCodeScreenState extends State<ProfileCountryCodeScreen> {
                            ...
                            return Column(
                              children: [
                                ListTile(
                                  ...
                                  onTap: () {
                                    controllers.selectedCountry(country);
                                    Get.back();
                                  },
                                ),
